...
#
# Script generated by Vivado on Fri Dec 05 15:15:25 +0300 2025
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : arm_design.sh
...
#
# Usage        : arm_design.sh
#                arm_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                arm_design.sh [-rerun]
#                arm_design.sh [-reset_run]
#                arm_design.sh [-clean]
#                arm_design.sh [-reset_log]
#                arm_design.sh [-help]
#
...
# script info
echo -e "arm_design.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./arm_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb arm_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./arm_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: arm_design.sh [-help]\n\
Usage: arm_design.sh [-step]\n\
Usage: arm_design.sh [-lib_map_path]\n\
Usage: arm_design.sh [-rerun]\n\
Usage: arm_design.sh [-reset_run]\n\
Usage: arm_design.sh [-clean]\n\
Usage: arm_design.sh [-reset_log]\n\
Usage: arm_design.sh [-keep_index]\n\
Usage: arm_design.sh [-noclean_files]\n\n\
