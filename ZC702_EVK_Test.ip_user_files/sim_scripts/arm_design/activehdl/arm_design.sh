...
#                script (type 'arm_design.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/CK/Desktop/FPGA_Workspace/VIVADO_PROJECTS/ZC702_EVK_Test/ZC702_EVK_Test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
