...
/*IMPORTANT NOTE:
FSBL Inits clocks etc therefore even if the clock is changed on zynq core in diagram 
clock was staying same in vitis. I needed to create platform and project again!!!
That is the reason why the throughput is not changed even if i have slowed down the clock

125 MHz gives 990Megabyte/sec
150 MHz gives 1200Megabyte/se ddr write speed with dma interrupt. 150 is the max of HP port
to create 150 MHz clock i set 155 it generates 150 but WNS TNS timing starts to give red
142 MHz gives 1130Megabyte/sec
*/
